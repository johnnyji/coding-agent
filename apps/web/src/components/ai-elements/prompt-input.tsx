...
export const PromptInputActionAddScreenshot = ({
  ...
  return (
    <DropdownMenuItem {...props} onClick={handleClick as unknown as React.MouseEventHandler<HTMLDivElement>}>
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    (e: React.MouseEvent<HTMLButtonElement>) => {
      ...
      (onClick as unknown as ((e: React.MouseEvent<HTMLButtonElement>) => void))?.(e);
    },
